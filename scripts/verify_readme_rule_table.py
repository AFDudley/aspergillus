...
Reads the target rule-taxonomy doc (README.md) and, for each of the four
ASP-FSM rules (FsmEnumDispatchExhaustive, FsmEdgeDuration,
...
Usage: verify_readme_rule_table.py <path-to-doc>
"""
